...
- (void)viewDidLoad {
    ...
    _path = @"http://39.134.65.162/PLTV/88888888/224/3221225611/index.m3u8";
    _path = @"http://amdlive.ctnd.com.edgesuite.net/arirang_1ch/smil:arirang_1ch.smil/playlist.m3u8";
    _path = @"rtmp://media3.scctv.net/live/scctv_800";
    //小文件 10秒
